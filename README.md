...
•	Firebase Authentication – Secure user login and UID-based data isolation
•	Google Firestore DB – Real-time NoSQL database for storing energy records, lab metadata, and timestamps
•	Firebase Hosting – Deployment of the whole application
•	Firebase Web SDK – Frontend data access and real-time querying
•	Firestore REST API – Direct data ingestion from ESP32 devices
